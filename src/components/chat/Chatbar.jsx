...
function Chatbar({ onSend, onStop, disabled, streaming }) {
  ...
  return (
    <div className="relative">
      <div className="flex items-end gap-2 rounded-2xl border border-white/10 bg-[#1a1a1a] p-2 pr-2.5 shadow-xl transition-all duration-200 focus-within:border-indigo-500/40 focus-within:shadow-indigo-500/5">
        <textarea
          ref={textareaRef}
          rows={1}
